...
`docs/archive/reviews/refactor-2026-07/`. Disputes were resolved by re-reading the
...
- **Future direction (v3 consensus, `docs/active/design-conversational-layer.md`):**
...
PTT-only vs wake word. See `docs/active/design-conversational-layer.md`.
