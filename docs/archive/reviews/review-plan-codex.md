...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase1-2.md, Phase 1 state/announce flow
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase1-2.md, §3 Announce flow
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase1-2.md, §3 Chime etiquette and §4 Floor-grant
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase1-2.md, §2 Session state file
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase1-2.md, §2 Hygiene; docs/archive/plan-details-phase3-4.md, §4.6 Data flow
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase1-2.md, §6 Local STT + hotkey
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase1-2.md, §6 Capture
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase1-2.md, §8 Talk-to-agent
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase3-4.md, §4.6 Data flow
...
- **Severity:** major
- **Doc:** docs/archive/plan-details-phase3-4.md, §3.1 Serial listener
...
- **Severity:** minor
- **Doc:** docs/archive/plan-room-of-devs.md, Decision 13; docs/archive/plan-details-phase1-2.md, §4 Floor-grant
...
- **Severity:** minor
- **Doc:** docs/archive/plan-details-phase1-2.md, §3 Announce flow; docs/archive/plan-details-phase3-4.md, §4.9 shared entry points
...
- **Severity:** minor
- **Doc:** docs/archive/plan-details-phase3-4.md, §4.6 and §4.9
