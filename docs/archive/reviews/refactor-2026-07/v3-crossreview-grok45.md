...
`ptt.sh`, `config.ts` / `gemini.ts`, `docs/shipped/spec-ui-refactor.md`,
`docs/archive/design-multi-agent-v2-hermes.md`, `docs/shipped/spec-live-mode-v2.md`, and
`docs/reference/ideas-backlog.md`. No daemon/API calls.
...
### Q4 — Staged path + minimal `docs/shipped/spec-ui-refactor.md` amendments
...
**Minimal amendments to `docs/shipped/spec-ui-refactor.md` (merge of three, cut to necessity):**
