...
`docs/shipped/spec-ui-refactor.md` (Phase 5 section + owner decisions, all final).
Live-mode UI contract: `docs/shipped/spec-live-mode-v2.md`. Judgment calls made
...
| ----- | ---- | ---------- |
| A — mock harness | `tts-server/scripts/mock-live.ts`, `tts-server/fixtures/live/`, `docs/reference/testing-live-mode.md` | nothing |
...
Docs: `docs/reference/testing-live-mode.md` — lane 1 (this harness, free), lane 2
...
live checks in E. Baseline: `docs/archive/reviews/refactor-2026-07/baseline/`
