...
Answers to brief-v3 Q1–Q4. Grounded in `docs/shipped/spec-ui-refactor.md`,
`docs/archive/design-multi-agent-v2-hermes.md`, `docs/shipped/spec-live-mode-v2.md`,
`docs/reference/ideas-backlog.md`, and current code under `tts-server/` + `scripts/`.
...
Hermes (`docs/archive/design-multi-agent-v2-hermes.md`) solves **task
...
### Amendments to `docs/shipped/spec-ui-refactor.md`
