...
| --- | --- |
| `.avatar-wrap.speaking-pop` | `docs/shipped/design-avatar-lipsync.md` (Speaking emphasis section still describes adding `speaking-pop` in dock mode). Not referenced from code comments. |
