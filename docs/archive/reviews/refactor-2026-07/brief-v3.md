...
1. `CLAUDE.md`, `docs/shipped/spec-ui-refactor.md` (the v2 consensus you built).
2. `docs/archive/design-multi-agent-v2-hermes.md` — the owner's earlier Hermes
   orchestration design (2026-05-21, pre-dates the room UI).
3. `docs/shipped/spec-live-mode-v2.md` — current live call/chat mode.
4. `docs/reference/ideas-backlog.md` — check for related entries before proposing
   "new" ideas.
...
a. **In-house interpreter service in the daemon**: STT transcript →
   ...
   fast-path.
b. **Hermes orchestration** per `docs/archive/design-multi-agent-v2-hermes.md` —
...
`docs/shipped/spec-ui-refactor.md`: new packages/services, protocol reservations,
