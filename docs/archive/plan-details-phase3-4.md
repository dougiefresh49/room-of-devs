...
*Implementation spec — 2026-07-06 — rev 3 — post multi-agent review — companion to docs/archive/plan-room-of-devs.md. Personal dev tool; simple beats robust.*
...
The hardware design doc (docs/active/design-arcade-button-controller.md) carries a dated architecture-update note reflecting this split; its Pi Model B instructions are a legacy appendix.
