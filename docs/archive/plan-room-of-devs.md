...
Claude Code-first. Hermes orchestration (docs/archive/design-multi-agent-v2-hermes.md) stays a v2 follow-on, not part of this plan.
...
- docs/active/design-arcade-button-controller.md carries the hardware details; its Pi Model B path is a legacy appendix

## Phase 4 — Agent Panel (avatars, always-on-top)

**Goal:** see the room; click to interact.

- Small floating window: agents with static AI-generated portraits (per docs/shipped/design-avatar-pipeline.md 2D path), name, state badge, hand-raised queue count
