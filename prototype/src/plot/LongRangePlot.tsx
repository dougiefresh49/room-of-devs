...
export function LongRangePlot() {
  ...
  const onDrag = useCallback((clientX: number, clientY: number, svg: SVGSVGElement) => {
                      ...
                      return (
                        <g key={p.id}>
                          <rect
                            ...
                            height={live ? 20 : 16}
                            rx="2"
                            fill={live ? "rgba(255,150,30,.08)" : queued ? "none" : "#23272c"}
              ...
              <g className="pl-conduit" fill="none" strokeWidth="1">
                {craftBlips
                  ...
                  .map((c) => {
                    ...
                    return <path key={c.id} d={`M502 166 L${p.x} ${p.y}`} />;
                  })}
              </g>
