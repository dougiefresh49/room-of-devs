            ...
            <div className="crib-grid">
              <aside className="crib-rail">
                ...
                <div className="crib-rail-note">
                  ...
                  <p>
                    Generated manifest unions exports and greps{" "}
                    <code>from &quot;@room/ui&quot;</code> plus <code>@room/ui/rig</code>. Zero hits ⇒ red lamp. Counts
                    render from the file — never hardcoded in JSX.
                  </p>
                </div>
              </aside>
